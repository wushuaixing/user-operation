...
const workbenchTopAsset = [
  ...
  },
  {
    ...
    subtitle_left: '正式机构',
    subtitle_right: '试用机构',
    field: ['incrFormalOrg', 'incrTrialOrg'],
    key: 2,
  },
  {
    id: 'third',
    ...
    subtitle_left: '正式机构',
    subtitle_right: '试用机构',
    field: ['formalContractOrg', 'trialContractOrg', 'historyContract'],
    key: 3,
  },
  {
    id: 'fourth',
    ...
    subtitle_left: '正式机构',
    subtitle_right: '试用机构',
    field: ['willExpireFormalOrg', 'willExpireTrialOrg', 'expiredOrg'],
    key: 4,
  },
  {
    id: 'fifth',
    ...
    subtitle_left: '正式机构',
    subtitle_right: '试用机构',
    field: ['formalOrgObligor', 'trialOrgObligor'],
    key: 5,
  },
];
const columns = [
